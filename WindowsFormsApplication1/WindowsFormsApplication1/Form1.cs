...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void t_Tick(object sender, EventArgs e)
        {
            ...
            //hour hand
            handCoord = msCoord(hh % 12, mm, hrHAND);
        ...
        {
            int[] coord = new int[2];
            val *= 6;       //each minute and second hand make a 6 degree angle
        ...
        private int[] msCoord(int hval, int mval, int hlen)
        {
            int[] coord = new int[2];
            
            //each hour makes a 30 degree angle
            //each minute makes 0.5 degree angle
